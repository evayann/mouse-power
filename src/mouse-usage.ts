...
export class MouseUsage extends LitElement {
  ...
  render(): TemplateResult {
    return html`
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 528 439">
        <g class="Mouse With Indicators">
          ...
          <path
            stroke=${this.isLeftClick ? "red" : "currentColor"}
            stroke-linecap="round"
            stroke-width="15"
          ...
          />
          <path
            stroke=${this.isRightClick ? "red" : "currentColor"}
            stroke-linecap="round"
            stroke-width="15"
          ...
          <g
            class="Mouse Move"
            stroke=${this.isMoving ? "red" : "currentColor"}
          >
            <path
              stroke-linecap="round"
              stroke-width="15"
          ...
          <path
            stroke=${this.isScroll ? "red" : "currentColor"}
            stroke-linecap="round"
            stroke-width="2"
